                ...
                <div className="w-full max-w-6xl bg-card border border-border rounded-[3.5rem] p-16 lg:p-24 shadow-[0_0_100px_rgba(0,0,0,0.1)] dark:shadow-[0_0_100px_rgba(0,0,0,0.5)] transition-all duration-500 relative group overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                        ...
                        {isOtpSent && !otpVerified && (
                            <div className="md:col-span-2 space-y-4 mb-6 animate-in fade-in slide-in-from-top-4 duration-500">
                                <label className="text-[10px] font-black tracking-[0.2em] text-muted-foreground mb-1 ml-2 opacity-50 transition-colors">Enter OTP Sent to Official Email</label>
                                <div className="relative group/field">
                        ...
                        <div className="md:col-span-2 mt-8">
                            <button
                                ...
                                className="w-full bg-primary text-primary-foreground py-8 rounded-[2rem] font-black text-[11px] tracking-[0.4em] transition-all shadow-2xl shadow-primary/20 hover:scale-[1.02] active:scale-95 shadow-glow shadow-primary/30 flex items-center justify-center gap-4 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {loading || otpLoading ? (
                                    <>
                        ...
                        <div className="md:col-span-2 text-center text-[10px] font-black tracking-[0.3em] text-muted-foreground opacity-30 mt-8 transition-colors">
                            <p className="mt-8">
                                Already registered? <Link to="/department-login" className="text-primary hover:text-foreground transition-all underline underline-offset-4 decoration-border">Access Login Console</Link>
                            </p>
                        </div>
                    </form>
                </div>
