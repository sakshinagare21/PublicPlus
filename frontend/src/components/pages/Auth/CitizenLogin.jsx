...
const CitizenLogin = () => {
 ...
 "http://127.0.0.1:5000/api/users/login", // ✅ correct route
 {
 method: "POST",
 headers: {
 ...
 <button
 type="submit"
 className="w-full bg-primary text-primary-foreground py-6 rounded-2xl font-bold text-sm transition-all shadow-2xl shadow-primary/20 hover:scale-[1.02] active:scale-95 shadow-glow shadow-primary/20 mt-4"
 >
 Login
 </button>
