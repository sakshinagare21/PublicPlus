...
const ReportIssue = () => {
 ...
 await axios.post("http://127.0.0.1:5000/api/issues", formData, {
 headers: { Authorization: `Bearer ${token}` },
 });
 ...
 <input type="file" multiple onChange={handleImage} className="absolute inset-0 opacity-0 cursor-pointer" />
 ...
 <div className="space-y-2">
 <h2 className="text-2xl font-black text-foreground flex items-center gap-3">
 <MapPin className="text-primary" /> Geospatial Origin
 </h2>
 <p className="text-sm text-muted-foreground font-medium">Synchronize the incident coordinates via satellite or drop a marker on the map.</p>
 </div>
 ...
 <label className="text-[10px] font-black tracking-widest text-muted-foreground mb-2 block font-mono opacity-50">Identified Strategic Node</label>
 ...
 <p className="text-sm text-muted-foreground font-medium">Provide a descriptive brief and category for the rapid dispatch system.</p>
 </div>

 <div className="space-y-6">
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1">Headline</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1">Infrastructure Division</label>
 ...
 <label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1">Observation Brief</label>
 ...
 Review Intelligence <ChevronRight size={14} className="group-hover:translate-x-1 transition-transform" />
 </button>
 </div>
 </div>
 )}
 ...
 <p className="text-[10px] text-muted-foreground font-bold tracking-[0.2em]">Incident Ready for Transmission</p>
 </div>
 </div>
 ...
 <p className="text-[10px] font-black tracking-widest text-muted-foreground mb-2">Target Division</p>
 ...
 <div className="space-y-6">
 <div className="px-2">
 <p className="text-[10px] font-black tracking-widest text-muted-foreground mb-3">Incident Headline</p>
 ...
 <p className="text-[10px] font-black tracking-widest text-muted-foreground mb-4 block">Citizen Brief</p>
 ...
 Visual Evidence Grid <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-[8px] font-black border border-primary/20">{images.length} ARTIFACTS</span>
 </p>
 ...
 {isSubmitting ? "TRANSMITTING TELEMETRY..." : "AUTHORIZE DISPATCH"}
