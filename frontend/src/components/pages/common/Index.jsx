...
const stats = [
  { value: "12,482", label: "Total improvements tracked" },
  { value: "48", label: "Active municipal partners" },
  { value: "3.2 Days", label: "From report to action" },
  { value: "94%", label: "Community trust rating" },
];
...
const steps = [
  {
    ...
    title: "Report",
    desc:
      "Citizens snap a photo or describe an issue. Our AI automatically geolocates and tags the infrastructure category.",
  },
  {
    icon: BarChart3,
    num: "2",
    title: "Analyze",
    desc:
      "The platform prioritizes issues based on safety, urgency, and community impact, delivering data-rich insights to city officials.",
  },
  {
    icon: CheckCircle2,
    num: "3",
    title: "Resolve",
    desc:
      "Governments assign tasks and update statuses in real-time. Citizens get notified the moment the issue is closed.",
  },
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="animate-fade-in">
              ...
              <p className="mt-6 max-w-lg text-lg text-muted-foreground">
                Bridging the gap between citizens and local governments through transparent, AI-driven infrastructure management and real-time response tracking.
              </p>
      ...
      <section id="features" className="container py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Our seamless three-step process ensures every concern is heard, categorized, and resolved efficiently.
          </p>
        </div>
  ...
  <div className="grid items-center gap-12 lg:grid-cols-2">
    ...
    <div>
      ...
      <p className="mt-4 text-muted-foreground leading-relaxed">
        Civic Intel was founded on a simple premise: technology should bring people closer to the systems that serve them. We believe that by providing clear, data-driven pathways for accountability, we can foster stronger, more resilient communities.
      </p>
      ...
      <div className="mt-8 grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Privacy-preserving AI that protects citizen identity while surfacing truth.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Empowering third-party auditors and researchers with API access.
          </p>
        </div>
...
<section className="container pb-20">
  <div
    ...
    style={{ background: "var(--stats-gradient)" }}
  >
    <h2 className="font-display text-2xl font-bold text-primary-foreground sm:text-3xl">
      Stay Informed on Civic Improvements
    </h2>

    <p className="mt-2 text-sm text-primary-foreground/70">
      Get monthly reports on urban progress and new infrastructure projects in your area.
    </p>

    <div className="mt-6 mx-auto flex max-w-md gap-3">
      <input
        placeholder="Enter your email address"
        className="flex-1 rounded-lg bg-primary-foreground/10 border border-primary-foreground/20 px-4 py-2.5 text-sm text-primary-foreground placeholder:text-primary-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary-foreground/30"
      />
