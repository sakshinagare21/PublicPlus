...
const TeamManagement = () => {
 ...
 "http://127.0.0.1:5000/api/departments/operators",
 {
 headers: {
 ...
 `http://127.0.0.1:5000/api/operator/department/operator/${id}`,
 {
 ...
 `http://127.0.0.1:5000/api/operator/department/operator/${id}/stats`,
 {
 headers: { Authorization: `Bearer ${token}` },
 },
 );
 ...
 <div className={`px-4 py-1.5 rounded-lg text-[10px] font-black tracking-widest flex items-center gap-2 border ${
