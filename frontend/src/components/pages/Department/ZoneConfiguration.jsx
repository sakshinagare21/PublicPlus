...
const ZoneConfiguration = () => {
 ...
 <tr>
 <td colSpan="6" className="p-16 text-center text-sm font-medium text-muted-foreground opacity-50 italic">
 ...
 zone.status === 'active' ? 'bg-emerald-500/10 text-emerald-500' : 
 ...
 <td className="p-5">
 <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wider ${
 zone.priority === 'high' ? 'bg-red-500/10 text-red-500' : 
