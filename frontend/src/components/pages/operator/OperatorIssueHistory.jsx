...
const OperatorIssueHistory = () => {
 ...
 Issue <span className="text-primary italic">History</span>
 </h1>
 </div>
 ...
 <h3 className="text-xl font-bold text-foreground italic tracking-tighter leading-tight group-hover:text-primary transition-colors">
 {issue.title}
 </h3>
 ...
 <h2 className="text-3xl font-bold text-foreground italic tracking-tighter">{selectedIssue.title}</h2>
 </div>
 ...
 <p className="text-sm font-bold text-foreground leading-relaxed italic opacity-80 group-hover:opacity-100 transition-opacity">
