...
const OperatorMyTasks = () => {
 ...
 axios.get("http://127.0.0.1:5000/api/issues/operator/issue", {
 headers: { Authorization: `Bearer ${token}` },
 }),
 axios.get("http://127.0.0.1:5000/api/issues/operator/stats", {
 headers: { Authorization: `Bearer ${token}` },
 })
 ]);
 ...
 <img src={`http://localhost:5000${selectedTask.media[0].url}`} className="w-full h-full object-cover" alt="Mission Scan" />
 ) : (
