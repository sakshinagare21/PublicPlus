                                ...
                                >
                                    <div className="relative aspect-video overflow-hidden">
                                        ...
                                        <div className="absolute top-4 right-4">
                                            <span className={`text-[9px] font-black px-3 py-1 rounded-lg shadow-xl tracking-widest border transition-colors ${issue.status === 'resolved' ? 'bg-success text-white border-success/50 shadow-glow-success' : 'bg-amber-500 text-white border-amber-500/50 shadow-glow-amber'
                                                }`}>
