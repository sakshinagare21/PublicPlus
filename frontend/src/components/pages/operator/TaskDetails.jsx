...
const TaskDetails = () => {
 ...
 <p className="text-foreground/80 font-medium text-sm leading-relaxed transition-colors italic">
 "{task.description}"
 </p>
 ...
 className="w-full bg-background border border-border rounded-2xl p-6 text-[11px] font-black tracking-widest outline-none focus:ring-4 focus:ring-primary/10 transition-all shadow-inner transition-colors placeholder:text-muted-foreground/20 italic"
 rows="4"
 />
 </div>
