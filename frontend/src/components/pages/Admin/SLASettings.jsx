...
export default function SLASettings() {
 ...
 `http://127.0.0.1:5000/api/sla/get-sla?priority=${priority}`,
 {
 headers: {
 ...
 const res = await fetch("http://127.0.0.1:5000/api/sla/get-sla", {
 headers: {
 "Content-Type": "application/json",
 "Authorization": `Bearer ${token}`
 }
...
const saveSLA = async () => {
 ...
 const res = await fetch("http://127.0.0.1:5000/api/sla/set-sla", {
 method: "POST",
 headers: {
 "Content-Type": "application/json",
 ...
 sla.priority === 'critical' ? 'bg-destructive/10 text-destructive border border-destructive/20' : 
